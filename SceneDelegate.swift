...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    func scene(_ scene: UIScene, willConnectTo session: UISceneSession, options connectionOptions: UIScene.ConnectionOptions) {
        ...
        let listVC = ReminderListViewController()
        let listNav = UINavigationController(rootViewController: listVC)
        listNav.navigationBar.prefersLargeTitles = true // Smoother UI
        listNav.tabBarItem = UITabBarItem(title: "Reminders", image: UIImage(systemName: "list.bullet"), tag: 0)
        ...
        tabBarController.viewControllers = [listNav, settingsNav]
